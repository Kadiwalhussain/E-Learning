# Generated by Django 5.1.1 on 2026-01-15 06:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('courses', '0003_contentbase_orderedcontent'),
    ...
    operations = [
        migrations.AlterField(
            model_name='content',
            name='content_type',
            field=models.ForeignKey(limit_choices_to={'model__in': ('text', 'textitem', 'file', 'image', 'video')}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype'),
        ),
        migrations.AlterField(
            model_name='content',
            name='module',
